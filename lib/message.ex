defmodule DBux.Message do
  ...
  """
  @spec build_method_call(DBux.Serial.t, String.t, String.t, DBux.Value.list_of_values, String.t | nil) :: %DBux.Message{}
  ...
  """
  @spec build_signal(DBux.Serial.t, String.t, String.t, String.t,  DBux.Value.list_of_values) :: %DBux.Message{}
  ...
  """
  @spec build_method_return(DBux.Serial.t, DBux.Serial.t, DBux.Value.list_of_values) :: %DBux.Message{}
  ...
  """
  @spec build_error(DBux.Serial.t, DBux.Serial.t, String.t, DBux.Value.list_of_values) :: %DBux.Message{}
